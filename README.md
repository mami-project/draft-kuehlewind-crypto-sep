...
This is the working area for the Individual internet-draft "draft-kuehlewind-crypto-sep".

* [Editor's copy](https://mami-project.github.io/draft-kuehlewind-crypto-sep/)
* [Individual Draft] (https://tools.ietf.org/html/draft-kuehlewind-crypto-sep)
* [Compare Individual Draft and Editor's copy] (https://tools.ietf.org/rfcdiff?url1=https://tools.ietf.org/id/draft-kuehlewind-crypto-sep.txt&url2=https://mami-project.github.io/draft-kuehlewind-crypto-sep/draft-kuehelwind-crypto-sep.txt)
...
documents](https://datatracker.ietf.org/wg/plus/documents/) and [mailing
list discussion](https://mailarchive.ietf.org/arch/browse/plus/). If you're
...
([info](https://www.ietf.org/mailman/listinfo/plus)). This will ensure that
